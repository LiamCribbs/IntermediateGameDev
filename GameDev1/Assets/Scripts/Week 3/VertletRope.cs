...
public class VertletRope
{
    ...
    public void Setup()
    {
        ///segments = Mathf.RoundToInt(defaultSegments * OptionsMenu.ropeSimulationQuality);
    ...
    public void DrawRope()
    {
        ...
        if (interpolate)
        {
            ...
            {
                ropePositions[i] = ropeSegments[i].posNow + (ropeSegments[i].posNow - ropeSegments[i].posOld) * t;
            }
        }
        else
        {
